...
apt_install python3 python3-venv python3-pip nginx snapd openssl curl rsync sqlite3 qrencode ca-certificates lsof net-tools iproute2 ufw unzip git jq gnupg software-properties-common
