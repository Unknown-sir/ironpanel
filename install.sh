...
apt-get update
DEBIAN_FRONTEND=noninteractive apt-get install -y python3 python3-venv python3-pip nginx certbot openssl curl rsync sqlite3 qrencode iptables-persistent ca-certificates
