...
## 19.1.0
- Added per-protocol speed limits.
- Added modern Routing Rules for protocol-to-outbound mapping.
- Fixed Update Manager completion state to 100%.
- Added terminal update command to README.
