...
## Real traffic accounting (v19.10.13)

Runtime counters for OpenVPN, WireGuard, Xray, Cisco/Ocserv, L2TP, PPTP, Hysteria2 and Telegram Proxy are merged into each user's shared quota. Traffic-sensitive panel and public subscription pages perform a short locked refresh before rendering so they do not show stale database values.
