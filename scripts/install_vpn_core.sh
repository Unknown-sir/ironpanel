...
if [[ -x /opt/ironpanel/scripts/repair_l2tp.sh ]]; then
  IRONPANEL_PUBLIC_HOST="$PUBLIC_HOST" ETC_DIR="$ETC_DIR" L2TP_PORT="$L2TP_PORT" bash /opt/ironpanel/scripts/repair_l2tp.sh --install-core || true
fi
# WireGuard core
