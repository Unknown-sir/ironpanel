...
def _load_direct_ports_raw(value=None):
    ...
    if isinstance(raw, dict):
        ...
        try:
            ...
            # v19.9.24: tolerate malformed values like {"telegram_proxy":6974}}
...
def _curl_post_json(base, token, path, data):
    # v19.9.24: urllib can time out on IP/SNI-mismatched TLS on some
...
def handle_job(job):
    ...
    if action == 'sync_protocol_configs':
        ...
        # v19.9.24: Do not reinstall/restart all protocol cores on every user
