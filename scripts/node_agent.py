...
def metrics():
    ...
    return {'version':VERSION,'agent_version':VERSION,'cpu_percent':cpu,'ram_percent':ram,'disk_percent':disk,'traffic_rx_bytes':rx,'traffic_tx_bytes':tx,'public_ip':sh('curl -fsS4 --max-time 3 https://api.ipify.org || true')}
