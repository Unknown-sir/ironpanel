...
بکاپ Migration حالا دیتابیس اتمیک، همه کاربران/نماینده‌ها/تنظیمات/دامنه‌ها و Identity کامل پروتکل‌ها را نگه می‌دارد تا بعد از Restore روی سرور جدید Tokenها و کلیدهای قبلی حفظ شوند و کانفیگ‌های دامنه‌محور قبلی با انتقال DNS به سرور جدید ادامه کار دهند.
