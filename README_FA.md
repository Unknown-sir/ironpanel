...
**IronPanel** یک پنل مدیریتی حرفه‌ای برای مدیریت، فروش، مانیتورینگ و تحویل کانفیگ سرویس‌های VPN است. نسخه v18 با طراحی جدید **VPN-UI Dark Teal**، پشتیبانی از پروتکل‌های بیشتر، صفحه سابسکریپشن مدرن‌تر، QR Code برای کانفیگ‌ها، بهبود WireGuard و Cisco AnyConnect/Ocserv و اضافه شدن PPTP و Hysteria2 آماده شده است.
...
امکانات پنل بر اساس نوع لایسنس فعال می‌شود. Xray و قابلیت‌های پایه پروتکل‌های جدید برای همه لایسنس‌ها قابل فعال‌سازی هستند و بخش‌هایی مثل نودها، فروش، مالی و شبکه طبق سطح لایسنس کنترل می‌شوند.

| نوع لایسنس | امکانات |
|---|---|
| Beginer | بخش‌های پایه، بدون نودها، فروش، مالی و شبکه |
| Plus | امکانات کامل‌تر، بدون ربات فروش، مالی و شبکه |
| Pro | همه بخش‌ها به‌جز مالی |
| Admin License | همه امکانات |
| Trial | همه امکانات به مدت ۷ روز |
