...
from ..services.provisioning import sync_user, delete_user, log, service_status, user_access_status, user_usage_summary, subscription_url_for_user
...
def create_user():
    ...
    u = VpnUser(username=username,
                ...
                protocols=','.join(data.get('protocols') or ['openvpn','ocserv','l2tp','wireguard','xray','pptp','hysteria2','telegram_proxy','ssh']),
