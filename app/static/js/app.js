...
(function(){
  ...
  var ar = Object.assign({}, en, {'Dashboard':'لوحة التحكم','Users':'المستخدمون','Save':'حفظ','Delete':'حذف','Edit':'تعديل','Search':'بحث','Settings':'الإعدادات'});
  var ru = Object.assign({}, en, {'Dashboard':'Панель','Users':'Пользователи','Save':'Сохранить','Delete':'Удалить','Edit':'Изменить','Search':'Поиск','Settings':'Настройки'});
  ...
  function replaceTextNode(node, map){
    var raw=node.nodeValue || ''; var trimmed=raw.trim(); if(!trimmed || !map[trimmed]) return;
