...
def openapi():
    return jsonify(openapi='3.0.0', info={'title':'IronPanel API v2','version':'19.10.6'}, paths={'/api/v2/users':{},'/api/v2/users/{user_id}':{},'/api/v2/users/by-username/{username}':{},'/api/v2/plans':{},'/api/v2/nodes':{},'/api/v2/monitoring':{},'/api/v2/sessions':{},'/api/v2/resellers':{},'/api/v2/v17/subscription/{user_id}/{client_type}':{}})
...
def node_ping():
    return jsonify(success=True, service='ironpanel-master', node_api=True, version='19.10.6')
