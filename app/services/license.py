...
CACHE_SECONDS = 300
DEFAULT_FEATURES = {'nodes': True, 'sales_bot': True, 'billing': True, 'network': True, 'updates': True, 'xray': True, 'outbound': True, 'backup': True, 'monitoring': True, 'api': True, 'subscription': True, 'node_agent': True, 'outbound_failover': True}
TYPE_FEATURES = {
    'beginer': {'nodes': False, 'sales_bot': False, 'billing': False, 'network': False, 'updates': True, 'xray': True, 'outbound': True, 'backup': True, 'monitoring': True, 'api': True, 'subscription': True, 'node_agent': False, 'outbound_failover': True},
    'plus': {'nodes': True, 'sales_bot': False, 'billing': False, 'network': False, 'updates': True, 'xray': True, 'outbound': True, 'backup': True, 'monitoring': True, 'api': True, 'subscription': True, 'node_agent': True, 'outbound_failover': True},
    'pro': {'nodes': True, 'sales_bot': True, 'billing': False, 'network': True, 'updates': True, 'xray': True, 'outbound': True, 'backup': True, 'monitoring': True, 'api': True, 'subscription': True, 'node_agent': True, 'outbound_failover': True},
    'admin': {'nodes': True, 'sales_bot': True, 'billing': True, 'network': True, 'updates': True, 'xray': True, 'outbound': True, 'backup': True, 'monitoring': True, 'api': True, 'subscription': True, 'node_agent': True, 'outbound_failover': True},
    'trial': {'nodes': True, 'sales_bot': True, 'billing': True, 'network': True, 'updates': True, 'xray': True, 'outbound': True, 'backup': True, 'monitoring': True, 'api': True, 'subscription': True, 'node_agent': True, 'outbound_failover': True},
}
...
def feature_allowed(name):
    if name in ('updates', 'xray', 'outbound', 'backup', 'monitoring', 'api', 'subscription', 'outbound_failover'): return True
    return bool(current_license_features().get(name, True))

def feature_label(name):
    return {'nodes':'نودها / Multi Server','sales_bot':'ربات فروش','billing':'مالی','network':'شبکه و دامنه','updates':'آپدیت','xray':'Xray / V2Ray','outbound':'Outbound Routing','backup':'Backup / Restore','monitoring':'Monitoring','api':'API','subscription':'Subscription','node_agent':'Node Agent','outbound_failover':'Outbound Failover'}.get(name,name)
