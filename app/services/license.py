...
CACHE_SECONDS = 300
DEFAULT_FEATURES = {'nodes': True, 'sales_bot': True, 'billing': True, 'network': True, 'updates': True, 'xray': True, 'outbound': True}
TYPE_FEATURES = {
    'beginer': {'nodes': False, 'sales_bot': False, 'billing': False, 'network': False, 'updates': True, 'xray': True, 'outbound': True},
    'plus': {'nodes': True, 'sales_bot': False, 'billing': False, 'network': False, 'updates': True, 'xray': True, 'outbound': True},
    'pro': {'nodes': True, 'sales_bot': True, 'billing': False, 'network': True, 'updates': True, 'xray': True, 'outbound': True},
    'admin': {'nodes': True, 'sales_bot': True, 'billing': True, 'network': True, 'updates': True, 'xray': True, 'outbound': True},
    'trial': {'nodes': True, 'sales_bot': True, 'billing': True, 'network': True, 'updates': True, 'xray': True, 'outbound': True},
}
...
def feature_allowed(name):
    if name in ('updates', 'xray', 'outbound'): return True
    return bool(current_license_features().get(name, True))

def feature_label(name):
    return {'nodes':'نودها / Multi Server','sales_bot':'ربات فروش','billing':'مالی','network':'شبکه و دامنه','updates':'آپدیت','xray':'Xray / V2Ray','outbound':'Outbound Routing'}.get(name,name)
