        ...
        for raw in raw_list:
            ...
            if base.is_file():
                ...
                try:
                    ...
                    pass
    return {'version':'19.8.16','protocols':selected,'files':files,'total_bytes':total[0]}
...
def force_protocols_to_node(node_id, protocols):
    ...
    v19.8.16: pipefail-safe real forward apply plus dynamic port detection; v19.8.14 fixed Internal Server Error from the web route, queues full
