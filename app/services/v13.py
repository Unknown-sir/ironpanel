...
"""
    ...
    if step == 4:
        ...
        if exit_file.exists():
            ...
            _write_step_state(running=True, step=5, progress=82, message='Files, dependencies and database upgraded', ok=True, done=False, upgrade_poll_count=elapsed)
            return {'ok': True, 'step': 5, 'next_step': 5, 'progress': 82, 'message': 'Files, dependencies and database upgraded', 'log': _tail_update_log(), 'done': False}
