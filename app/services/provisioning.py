...
PROTOCOLS = ['openvpn', 'ocserv', 'l2tp', 'wireguard', 'xray']
...
def active_protocols():
    raw = get_setting('active_protocols', 'openvpn,ocserv,l2tp,wireguard,xray')
...
def service_status():
    services = ['openvpn-server@server', 'xray', 'ocserv', 'strongswan-starter', 'xl2tpd', 'wg-quick@wg0', 'ironpanel']
    result = {}
    for svc in services:
...
def service_status_detailed():
    ...
    """
    services = ['openvpn-server@server', 'xray', 'ocserv', 'strongswan-starter', 'strongswan', 'xl2tpd', 'wg-quick@wg0', 'ironpanel']
    result = {}
    for svc in services:
...
def service_error_detail(service_name):
    allowed = ['openvpn-server@server', 'xray', 'ocserv', 'strongswan-starter', 'strongswan', 'xl2tpd', 'wg-quick@wg0', 'ironpanel']
