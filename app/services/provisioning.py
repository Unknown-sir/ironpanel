...
def service_status_detailed():
    ...
    """
    services = ['openvpn-server@server', 'ocserv', 'strongswan-starter', 'strongswan', 'xl2tpd', 'wg-quick@wg0', 'ironpanel']
    result = {}
    for svc in services:
...
def service_error_detail(service_name):
    allowed = ['openvpn-server@server', 'ocserv', 'strongswan-starter', 'strongswan', 'xl2tpd', 'wg-quick@wg0', 'ironpanel']
