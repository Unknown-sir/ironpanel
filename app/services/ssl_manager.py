...
def issue_and_apply_ssl(domain: str, email: str = '', force_xray_tls: bool = False) -> Dict[str, Any]:
    ...
    msg = 'SSL با موفقیت دریافت و روی IronPanel، Ocserv/AnyConnect، Hysteria2 و همه پروفایل‌های TLS در Xray اعمال شد. پروتکل‌هایی مثل OpenVPN/WireGuard/L2TP/PPTP به SSL دامنه‌ای نیاز ندارند.'
