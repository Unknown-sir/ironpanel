...
class VpnUser(db.Model):
    ...
    protocols = db.Column(db.String(120), default='openvpn,ocserv,l2tp,wireguard,xray,pptp,hysteria2')
    ...
    protocol_permissions = db.Column(db.String(120), default='openvpn,ocserv,l2tp,wireguard,xray,pptp,hysteria2')
...
class Node(db.Model):
    ...
    protocols = db.Column(db.String(160), default='openvpn,ocserv,l2tp,wireguard,xray,pptp,hysteria2')
