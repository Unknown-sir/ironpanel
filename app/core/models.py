...
class VpnUser(db.Model):
    ...
    enabled = db.Column(db.Boolean, default=True)
    protocols = db.Column(db.String(120), default='openvpn,ocserv,l2tp,wireguard,xray,pptp,hysteria2,telegram_proxy')
    ...
    protocol_permissions = db.Column(db.String(120), default='openvpn,ocserv,l2tp,wireguard,xray,pptp,hysteria2,telegram_proxy')
...
class Node(db.Model):
    ...
    protocols = db.Column(db.String(160), default='openvpn,ocserv,l2tp,wireguard,xray,pptp,hysteria2,telegram_proxy')
