...
def settings():
    ...
    if request.method == 'POST':
        ...
        set_setting('license_server_url', 'http://license.skyshield.space:8002')
        for key in ['panel','openvpn_udp','openvpn_tcp','ocserv_tcp','ocserv_udp','l2tp_udp','ipsec_ike','ipsec_nat','wireguard_udp','xray_tcp','xray_api']:
