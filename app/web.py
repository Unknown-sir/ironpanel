...
def settings():
    ...
    if request.method == 'POST':
        ...
        for key in ['panel','openvpn_udp','openvpn_tcp','ocserv_tcp','ocserv_udp','l2tp_udp','ipsec_ike','ipsec_nat','wireguard_udp','xray_tcp','xray_api','pptp_tcp','hysteria2_udp','telegram_proxy_base']:
