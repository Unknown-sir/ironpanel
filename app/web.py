...
def reseller_update(reseller_id):
    ...
    log(current_user.username, 'update_reseller', r.username, f'{r.panel_path}; protocols={r.reseller_protocols}; users_restricted={len(changed_users)}; state={reseller_state}')
