...
from .services.speed_limit import speed_limit_rows, save_speed_limits, apply_speed_limits_runtime, speed_limit_status, PROTOCOL_LABELS, PROTOCOL_ICONS, speed_limit_user_matrix, save_user_speed_limits, normalize_speed_limit_mbps, set_user_speed_limit
...
def users_bulk_create():
    ...
    lines = [
        'IronPanel v19.10.21 bulk users',
