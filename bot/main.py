...
def _sales_bot_config_username(order=None, plan=None, override_prefix=None):
    ...
    v19.9.21: do not use Telegram chat ID as the username base. Repeated
...
def _create_vpn_user_for_order(order, name_prefix=None):
    ...
    # v19.9.21: random five-digit config names, optionally prefix-12345.
...
async def receipt_handler(update, context):
    with flask_app.app_context():
        ...
        # v19.9.21: payment/receipt messages must take priority over stale admin
