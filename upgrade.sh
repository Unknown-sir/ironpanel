...
import os, sqlite3
p=os.environ.get('DATABASE_URL','')
vals={'OPENVPN_UDP':'1194','OPENVPN_TCP':'1195','OPENVPN_PROTO':'udp','OCSERV_PORT':'8445','OCSERV_TCP':'8445','OCSERV_UDP':'8445','WIREGUARD_PORT':'51820','IRONPANEL_WIREGUARD_MTU':'1360','WIREGUARD_MTU':'1360','IRONPANEL_WIREGUARD_KEEPALIVE':'25','XRAY_PORT':'443','XRAY_API_PORT':'10085','PPTP_PORT':'1723','HYSTERIA2_PORT':'4433','OCSERV_TRANSPORT':'tcp_udp','WIREGUARD_TRANSPORT':'udp','L2TP_TRANSPORT':'udp'}
