#!/usr/bin/env bash
set -euo pipefail
# v19.10.23 GitHub upgrade: migrations, usage accounting repair, node sync, and optional full core reconciliation.
...
cd "$APP_DIR"
run_upgrade_db_safe
# v19.10.23: reconcile automatic reseller suspensions after schema/limit changes.
