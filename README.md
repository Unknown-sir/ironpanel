...
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|---:|---|
| **OpenVPN** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | `1194` | تحویل فایل `username.ovpn` و مناسب برای اتصال پایدار |
| **WireGuard** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | `51820` | MTU پیش‌فرض `1280` و قابل تغییر از پنل |
| **Cisco / Ocserv** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | `443` | مناسب برای AnyConnect و پشتیبانی از SSL |
| **Xray / V2Ray** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | متغیر | پشتیبانی از کانفیگ‌های TLS/Reality/Subscription |
| **Hysteria2** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | `443/udp` | تحویل لینک `hy2://` و فایل YAML |
| **Telegram Proxy** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | `6969` | یک پورت مشترک، secret اختصاصی هر کاربر، مصرف جداگانه |
| **SSH** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | `422` | اکانت SSH محدود برای تونل/SSH Proxy |
...
- طراحی بهتر صفحه لاگین با استایل مدرن‌تر
- اضافه شدن Update Manager به منوی ساده
- اضافه شدن پروتکل SSH در نسخه 17
- به‌روزرسانی README با جدول امکانات پروتکل‌ها و لایسنس‌ها
