...
IronPanel تحت [لایسنس تجاری اختصاصی](LICENSE) منتشر می‌شود؛ اجرای کامل برخی ماژول‌ها نیازمند کلید لایسنس Plus/Pro/Admin است. نسخه رایگان Beginner بدون کلید نیز کار می‌کند (OpenVPN + Xray).
