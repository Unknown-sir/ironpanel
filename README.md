...
## 🧮 ثبت و نمایش مصرف واقعی (v19.10.13)

مصرف OpenVPN، WireGuard، Xray، Cisco/Ocserv، L2TP، PPTP، Hysteria2 و Telegram Proxy از runtime جمع‌آوری و در یک سهمیه مشترک کاربر ثبت می‌شود. صفحه کاربران، صفحه کانفیگ و لینک ساب قبل از نمایش، همگام‌سازی کوتاه و قفل‌شده انجام می‌دهند تا مقدار قدیمی دیتابیس نمایش داده نشود.
